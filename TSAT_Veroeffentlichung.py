...
def connectprimer():#connects to an existing database with information of framing regions and translation direction or adds new information to that database
    ...
    connprimer.execute("""CREATE TABLE IF NOT EXISTS all_framing_regions(Name TEXT,Sequence TEXT, Added TEXT, Translation_direction TEXT)""")
    ...
    def newentry():# new entry into the connected database
        ...
        connprimer2.execute("CREATE TABLE IF NOT EXISTS all_framing_regions(Name TEXT,Sequence TEXT, Added TEXT, Translation_direction TEXT)")
        def insertall():
            ...
            connprimer2.execute("INSERT INTO all_framing_regions(Name,Sequence,Added,Translation_direction) VALUES(?,?,?,?)",(ID,framingregions12,author,Primer12))
